...
public final class Model extends Animable {
			...
			if (triangleDrawType == null || triangleDrawType[k] != -1) {
				...
				if (flag && (i3 == -5000 || l3 == -5000 || k4 == -5000)) {
					...
					if ((i3 - l3) * (anIntArray1666[j2] - anIntArray1666[k1]) - (anIntArray1666[l] - anIntArray1666[k1]) * (k4 - l3) > 0) {
						...
						aBooleanArray1663[k] = i3 < 0 || l3 < 0 || k4 < 0 || i3 > DrawingArea.viewportEx || l3 > DrawingArea.viewportEx || k4 > DrawingArea.viewportEx;
	...
	private void method485(int i) {
		...
		if ((j3 - j4) * (k7 - j7) - (i7 - j7) * (j5 - j4) > 0) {
			...
			if (l == 3) {
				if (j3 < 0 || j4 < 0 || j5 < 0 || j3 > DrawingArea.viewportEx || j4 > DrawingArea.viewportEx || j5 > DrawingArea.viewportEx)
			...
			if (l == 4) {
				if (j3 < 0 || j4 < 0 || j5 < 0 || j3 > DrawingArea.viewportEx || j4 > DrawingArea.viewportEx || j5 > DrawingArea.viewportEx || anIntArray1678[3] < 0 || anIntArray1678[3] > DrawingArea.viewportEx)
					Rasterizer.aBoolean1462 = true;
				int i8;
				if (triangleDrawType == null)
					i8 = 0;
