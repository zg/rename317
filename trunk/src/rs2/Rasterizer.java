    ...
    public static void drawTriangle(int y_a, int y_b, int y_c, int x_a, int x_b, int x_c, int c_a, int c_b, int c_c) {
        ...
        if (y_a <= y_b && y_a <= y_c) {
            ...
            if (y_b < y_c) {
                ...
                if (y_a != y_b && j3 < j2 || y_a == y_b && j3 > l2) {
                    ...
                    for (y_a = lineOffsets[y_a]; --y_b >= 0; y_a += width) {
                        drawShadedLine(pixels, y_a, x_c >> 16, x_a >> 16, c_c >> 7, c_a >> 7);
                        x_c += j3;
                        x_a += j2;
                        c_c += k3;
                        c_a += k2;
                    ...
                    while (--y_c >= 0) {
                        drawShadedLine(pixels, y_a, x_c >> 16, x_b >> 16, c_c >> 7, c_b >> 7);
                        x_c += j3;
                        x_b += l2;
                        c_c += k3;
                        c_b += i3;
                ...
                y_b -= y_a;
                for (y_a = lineOffsets[y_a]; --y_b >= 0; y_a += width) {
                    drawShadedLine(pixels, y_a, x_a >> 16, x_c >> 16, c_a >> 7, c_c >> 7);
                    x_c += j3;
                    x_a += j2;
                    c_c += k3;
                    c_a += k2;
                ...
                while (--y_c >= 0) {
                    drawShadedLine(pixels, y_a, x_b >> 16, x_c >> 16, c_b >> 7, c_c >> 7);
                    x_c += j3;
                    x_b += l2;
                    c_c += k3;
                    c_b += i3;
            ...
            if (y_a != y_c && j3 < j2 || y_a == y_c && l2 > j2) {
                ...
                for (y_a = lineOffsets[y_a]; --y_c >= 0; y_a += width) {
                    drawShadedLine(pixels, y_a, x_b >> 16, x_a >> 16, c_b >> 7, c_a >> 7);
                    x_b += j3;
                    x_a += j2;
                    c_b += k3;
                    c_a += k2;
            ...
            y_c -= y_a;
            for (y_a = lineOffsets[y_a]; --y_c >= 0; y_a += width) {
                drawShadedLine(pixels, y_a, x_a >> 16, x_b >> 16, c_a >> 7, c_b >> 7);
                x_b += j3;
                x_a += j2;
                c_b += k3;
                c_a += k2;
        ...
        if (y_b <= y_c) {
            ...
            if (y_c < y_a) {
                ...
                if (y_b != y_c && j2 < l2 || y_b == y_c && j2 > j3) {
                    ...
                    for (y_b = lineOffsets[y_b]; --y_c >= 0; y_b += width) {
                        drawShadedLine(pixels, y_b, x_a >> 16, x_b >> 16, c_a >> 7, c_b >> 7);
                        x_a += j2;
                        x_b += l2;
                        c_a += k2;
                        c_b += i3;
                    ...
                    while (--y_a >= 0) {
                        drawShadedLine(pixels, y_b, x_a >> 16, x_c >> 16, c_a >> 7, c_c >> 7);
                        x_a += j2;
                        x_c += j3;
                        c_a += k2;
                        c_c += k3;
                ...
                y_c -= y_b;
                for (y_b = lineOffsets[y_b]; --y_c >= 0; y_b += width) {
                    drawShadedLine(pixels, y_b, x_b >> 16, x_a >> 16, c_b >> 7, c_a >> 7);
                    x_a += j2;
                    x_b += l2;
                    c_a += k2;
                    c_b += i3;
                ...
                while (--y_a >= 0) {
                    drawShadedLine(pixels, y_b, x_c >> 16, x_a >> 16, c_c >> 7, c_a >> 7);
                    x_a += j2;
                    x_c += j3;
                    c_a += k2;
                    c_c += k3;
            ...
            if (j2 < l2) {
                ...
                for (y_b = lineOffsets[y_b]; --y_a >= 0; y_b += width) {
                    drawShadedLine(pixels, y_b, x_c >> 16, x_b >> 16, c_c >> 7, c_b >> 7);
                    x_c += j2;
                    x_b += l2;
                    c_c += k2;
                    c_b += i3;
            ...
            y_a -= y_b;
            for (y_b = lineOffsets[y_b]; --y_a >= 0; y_b += width) {
                drawShadedLine(pixels, y_b, x_b >> 16, x_c >> 16, c_b >> 7, c_c >> 7);
                x_c += j2;
                x_b += l2;
                c_c += k2;
                c_b += i3;
        ...
        if (y_a < y_b) {
            ...
            if (l2 < j3) {
                ...
                for (y_c = lineOffsets[y_c]; --y_a >= 0; y_c += width) {
                    drawShadedLine(pixels, y_c, x_b >> 16, x_c >> 16, c_b >> 7, c_c >> 7);
                    x_b += l2;
                    x_c += j3;
                    c_b += i3;
                    c_c += k3;
                ...
                while (--y_b >= 0) {
                    drawShadedLine(pixels, y_c, x_b >> 16, x_a >> 16, c_b >> 7, c_a >> 7);
                    x_b += l2;
                    x_a += j2;
                    c_b += i3;
                    c_a += k2;
            ...
            y_a -= y_c;
            for (y_c = lineOffsets[y_c]; --y_a >= 0; y_c += width) {
                drawShadedLine(pixels, y_c, x_c >> 16, x_b >> 16, c_c >> 7, c_b >> 7);
                x_b += l2;
                x_c += j3;
                c_b += i3;
                c_c += k3;
            ...
            while (--y_b >= 0) {
                drawShadedLine(pixels, y_c, x_a >> 16, x_b >> 16, c_a >> 7, c_b >> 7);
                x_b += l2;
                x_a += j2;
                c_b += i3;
                c_a += k2;
        ...
        if (l2 < j3) {
            ...
            for (y_c = lineOffsets[y_c]; --y_b >= 0; y_c += width) {
                drawShadedLine(pixels, y_c, x_a >> 16, x_c >> 16, c_a >> 7, c_c >> 7);
                x_a += l2;
                x_c += j3;
                c_a += i3;
                c_c += k3;
        ...
        y_b -= y_c;
        for (y_c = lineOffsets[y_c]; --y_b >= 0; y_c += width) {
            drawShadedLine(pixels, y_c, x_c >> 16, x_a >> 16, c_c >> 7, c_a >> 7);
            x_a += l2;
            x_c += j3;
            c_a += i3;
            c_c += k3;
